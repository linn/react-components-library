...
| closeDialog | func | required | The function that closes the dialog. This should conventionally set the bool that is being passed as the 'visible' prop to false.