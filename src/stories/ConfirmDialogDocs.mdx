...
This component just provides the Dialog - i.e. the thing that will pop up and interrupt the user - you must implement the button or other mechanism for opening and closing the Dialog yoursel, and mangage its 'open' state externally. 
