...
- <b>searchResults</b> - array - the search results, each having an id, name and description property, and an optional array of chips, each with text and color string fields
