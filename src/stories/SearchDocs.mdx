...
- <b>searchResults</b> - array - the search results, each having an id, name and description property
...
This is achieved by either
 - passing your oqn function that takes the searchTerm, and any given search result object, and calculates a numeric priority for that result. This priority number is then used to sort the results, highest first.
...
The keyCode is the numeric key code of the desired key and the value is the function to call when that key is pressed.
