...
function (_Component) {
  ...
  _createClass(Breadcrumbs, [{
    ...
    value: function render() {
      ...
      var crumbs = path.split('/').reduce(function (sofar, crumb, i, crumbs) {
      ...
      return React__default.createElement("div", {
        ...
        return React__default.createElement("span", null, React__default.createElement(reactRouterDom.NavLink, {
          to: crumb.href,
          key: index
        }, React__default.createElement(Button, {
          variant: "contained"
          ...
          variant: "subtitle2"
        }, React__default.createElement("strong", null, crumb.caption)))), index < crumbs.length - 1 ? React__default.createElement(icons.ChevronRight, null) : false // dont show chevron pointing away from last crumb                 
        );
      }));
    }
  }]);
...
var Breadcrumbs$1 = styles.withStyles(styles$3)(Breadcrumbs);
...
var SaveCancelButtons$1 = styles.withStyles(styles$4)(SaveCancelButtons);
...
var FormField$1 = styles.withStyles(styles$5)(FormField);
...
var ReportTable$1 = styles.withStyles(styles$6)(ReportTable);
...
function (_Component) {
  ...
  _createClass(MiniLoading, [{
    ...
    value: function render() {
      return React__default.createElement("div", {
        style: styles$8.outer
      }, React__default.createElement("div", {
        style: _objectSpread({}, styles$8.loading)
      }), ' ', React__default.createElement("div", {
        style: _objectSpread({}, styles$8.loading, {
          animationDelay: '-1.0s'
        })
...
var Dropdown$1 = styles.withStyles(styles$9)(Dropdown);
...
var ErrorCard$1 = styles.withStyles(styles$a)(ErrorCard);
...
var CheckboxWithLabel$1 = styles.withStyles(styles$b)(CheckboxWithLabel);
...
var Title$1 = styles.withStyles(styles$c)(Title);
